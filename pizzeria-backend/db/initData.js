...
main().then(async ()=>{
    ...
    console.log("Data initialisation success");
    process.exit();
...
let pizzas = [
...

  {
    ...
    "image": "https://www.shutterstock.com/image-photo/pizza-margherita-italian-246331354?src=LdqMHwukPR6yE1l-dL7uMQ-1-11%22",
